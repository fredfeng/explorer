...
/**
 *Transformer for regularPT
 */
public class RegularPTTransformer extends SceneTransformer {
    ...
    @SuppressWarnings("rawtypes") Map options) {
        ...
        PointsToAnalysis onDemandAnalysis = RegularPT.makeWithBudget(DEFAULT_MAX_TRAVERSAL, DEFAULT_MAX_PASSES, DEFAULT_LAZY);
