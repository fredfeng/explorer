 ...
 */
public class myMethodPAG {
    private myPAG mypag;
    public myPAG mypag() { return mypag; }

    protected myMethodPAG( myPAG mypag, SootMethod m ) {
        this.mypag = mypag;
        this.method = m;
        this.myNodeFactory = new myMethodNodeFactory( mypag, this );
    }
    ...
    protected myMethodNodeFactory myNodeFactory;
    public MethodNodeFactory nodeFactory() { return nodeFactory; }

    public static myMethodPAG v( myPAG mypag, SootMethod m ) {
        myMethodPAG ret = G.v().MethodPAG_methodToPag.get( m );
        if( ret == null ) { 
            ret = new myMethodPAG( pag, m );
