...
ant observe -Dtarget.name=batik -Dtarget.type=NORMAL
echo "analyzing-----sunflow"
ant observe -Dtarget.name=sunflow -Dtarget.type=NORMAL
echo "analyzing-----fop"
ant observe -Dtarget.name=fop -Dtarget.type=NORMAL
echo "analyzing-----weka"
ant observe -Dtarget.name=weka -Dtarget.type=NORMAL
echo "analyzing-----jmeter"
ant observe -Dtarget.name=jmeter -Dtarget.type=NORMAL
