...
ant observe -Dtarget.name=batik -Dtarget.type=CHA
echo "analyzing-----sunflow"
ant observe -Dtarget.name=sunflow -Dtarget.type=CHA
echo "analyzing-----fop"
ant observe -Dtarget.name=fop -Dtarget.type=CHA 
echo "analyzing-----weka"
ant observe -Dtarget.name=weka -Dtarget.type=CHA
echo "analyzing-----jmeter"
ant observe -Dtarget.name=jmeter -Dtarget.type=CHA
